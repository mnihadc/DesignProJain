      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-10 lg:px-12 py-10 text-white bg-[#0A2463] slide-up-section">
        ...
        <section className="pb-8">
          ...
          <div className="space-y-6 text-sm md:text-[15px] leading-relaxed">
            ...
            <div className="pt-4">
              <h2 className="text-xl font-bold mb-4 text-[#f59e0b]">
            ...
            <div className="pt-4">
              ...
              <ul className="list-disc ml-6 space-y-3">
                ...
                <li>
                  Selected papers/posters will be presented offline in person by
                  the author/s during the conference on the 29th and 30th of
                  September 2026 at JAIN (Deemed-to-be University), Kochi.
                </li>
                <li>
                  The time duration for each of the paper presentations is 15
                  minutes, followed by 5 minutes for discussion along with Q &
                  A. The selected papers will be published after the conference.
                </li>
                <li>
                  Formatting guidelines as well as a template for the full paper
                  will be supplied along with the acceptance mail of the
                  abstract.
                </li>
                <li>
                  Selected paper (abstract) presentation in the conference
                  'Typography Day 2026' requires registration.
                </li>
                <li>
              ...
              <p className="mt-6">
                ...
                <a
                  href="https://event.leconfe.com/juk1/scheduled/abstract/panel/submissions"
                  target="_blank"
            ...
            <div className="pt-4 border-t border-white/10">
              ...
              <div className="space-y-2">
                ...
                <p>
                  <span className="text-[#f59e0b] font-bold">
                    Deadline for submission of full paper and Poster:
                  </span>{" "}
                  1st August 2026
                </p>
              </div>
        ...
        <section className="pt-4">
          ...
          <div className="space-y-6 text-sm md:text-[15px] leading-relaxed">
            <div>
              <h3 className="font-bold mb-4 text-lg border-l-4 border-[#f59e0b] pl-3">
              ...
              <div className="space-y-4">
                ...
                <p className="font-bold text-[#f59e0b] bg-white/5 p-3 rounded">
                ...
                <p>
                  ...
                  directly or indirectly, the entry will be disqualified. Data
                  about the identity of the author should be uploaded in a
                  separate file.
                </p>
              </div>
            </div>
