      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-10 lg:px-12 py-10 text-white bg-[#0A2463]">
        <section className="pb-8">
          ...
          <div className="text-sm md:text-[15px] leading-relaxed space-y-4">
            ...
            <p>
              The paper submission is open to all Indians and foreign citizens.
            </p>

            <p className="font-bold">Deadlines:</p>
            <p className="text-[#f59e0b] font-bold">Abstract: 25th May 2026</p>
            <p className="text-[#f59e0b] font-bold">
              Acceptance: 1st July 2026
            </p>
            <p className="text-[#f59e0b] font-bold">
              Full Paper: 1st August 2026
            </p>
