      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-10 lg:px-12 py-12 text-white bg-[#0A2463] slide-up-section">
        <section className="pb-6">
          ...
          <div className="text-sm md:text-[15px] leading-relaxed space-y-4">
            ...
            <p>
              Deadline for poster submission: <span className="font-bold text-[#f59e0b]">5th September 2026</span>
            </p>
            <p>
              Declaration of poster competition results: <span className="font-bold text-[#f59e0b]">15th September 2026</span>
            </p>
            ...
            <p>
              ...
              <a href="mailto:typographydaypopster2026@gmail.com" className="text-[#f59e0b] hover:underline">
                typographydaypopster2026@gmail.com
              </a>
            </p>
